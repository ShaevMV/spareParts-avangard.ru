...
final class RabbitMqConfigures
{
    ...
    private function queueDeclarator(
        ...
        return function (DomainEventSubscriber $subscriber) use (
            ...
            $retryQueueName = RabbitMqQueueNameFormatter::formatRetry(get_class($subscriber));
            $deadLetterQueueName = RabbitMqQueueNameFormatter::formatDeadLetter(get_class($subscriber));
