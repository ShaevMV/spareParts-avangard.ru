...
return [
    ...
    */
    ...
    'options' => [
        'slack_webhook' => env('SLACK_WEBHOOK_LOGS'),

        'application' => env('APP_NAME', 'Laravel'),
        'repository'  => 'git@gitlab-test.avangard-mb.ru:avangard/spareparts-avangard.ru',
    ],
    ...
    */
    ...
    'hosts' => [
        'spareparts-api.avangard-mb.ru' => [
            'deploy_path' => '/var/www/projects/spareparts-api.avangard-mb.ru',
            'user' => 'avangard',
            'identityFile' => '/home/avangard/.ssh/id_rsa',
        ],
    ],
